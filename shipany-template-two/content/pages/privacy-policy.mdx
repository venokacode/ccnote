...
description: Privacy policy for PD Note
created_at: 2026-01-12
---

## Introduction

Welcome to PD Note, an online note, kanban and progress tracking platform designed for internal customer support teams. At PD Note, your privacy is of utmost importance to us, and this privacy policy outlines how we collect, use, and protect your personal information when you use our services.

## Information Collection and Use

We collect the following types of data to provide you with a better experience while using PD Note:
...
2. **Usage Details**
   - **What We Collect**: Information about how you use PD Note, including your interactions, features accessed, and usage frequency.
   - **Purpose**: To analyze user engagement and improve our services.

3. **Device Information**
   - **What We Collect**: Data regarding the devices you use to access PD Note, such as device type, operating system, and browser type.
